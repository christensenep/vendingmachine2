...
public class MachineTest {
  ...
  public void displayThankYouTemporarilyWithSuccessfulPurchase() {
    ...
    this.machine.purchase(ProductType.COLA);
    assertEquals("THANK YOU", this.machine.getDisplay());
    assertEquals("INSERT COIN", this.machine.getDisplay());
  }
  ...
  @Test
  public void displaySoldOutWhenAttemptingPurchaseWithExactChangeInserted() {
    this.machine.addStoredCoins(generateMockCoins(0,0,1,0));
  ...
  @Test
  public void makeTenCentsChange() {
    this.machine.addStoredCoins(generateMockCoins(2,2,2,0));
    this.machine.makeChange(10);
  ...
  @Test
  public void makeTwentyFiveCentsChangeWithNoStoredQuartersAndOneDime() {
    this.machine.addStoredCoins(generateMockCoins(0,1,5,0));
    this.machine.makeChange(25);
    checkStoredCoins(0,0,2);
    checkReturnedCoins(0,1,3,0);
  }

  @Test
  public void makeSixtyFiveCentsChange() {
    this.machine.addStoredCoins(generateMockCoins(2,2,2,0));
    this.machine.makeChange(65);
